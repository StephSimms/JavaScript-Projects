...
function checkWinConditions() {
    ...
    //It si used to check for each win condition.
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        //This lines fives us access to methods and properties to use on canvas.
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //This conditions add 10 to the previous end y point.
            if (y < y2) { y += 10; }
