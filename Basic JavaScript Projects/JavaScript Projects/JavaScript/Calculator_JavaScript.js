...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        //this overwrites Display_Value fi the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //iin the Perform_Calculation object and the function that matches the 
...
//this function updates the screen with the contents of Disply_Value
