...
function get_todos() {
    ...
    /*if input is not null then JSON.parse will communicate with the web browser to make the task a JavaScript object.*/
    if (todos_str !== null) {
...
/* this creates the functionality of removing a todo item from the array*/
    function remove() {
        ...
        todos.splice(id, 1);
        localStorage.setItem('todo', JSON.stringify(todos));
        /*this looks lin the show() how to display a removed item on the screen*/
        show();

        return false;
    }

    /*this tells the browswer how to display the todo array after an item has been removed*/
